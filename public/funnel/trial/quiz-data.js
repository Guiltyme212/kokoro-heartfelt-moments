...
const STEPS = [
  ...
  /* paywall — TRIAL experiment: hero = 7-day free trial (€0.00 today),
     annual as the "skip the trial, best value" alternative. 2 plans only,
     index-aligned with STRIPE_LINKS / PLAN_VALUE / PLAN_NAME. countdown,
     card logos + "why people stay" reasons + a second CTA (long-scroll) */
  { id:'paywall', type:'paywall', sec:4,
    countdown:600,
    title:'your kokoro plan is ready.',
    sub:'start free tonight — your session and 7-day reset are waiting, in your tone, for what you need now.',
    perks:[
    ...
    plans:[
      {name:'7-day free trial', note:'€0.00 due today · then billed monthly · cancel anytime · we’ll remind you 2 days before it renews', price:'€19.99', perDay:'free for 7 days', best:true, cta:'start my free trial'},
      {name:'1 year', note:'billed €59.99 / year · or skip the trial — best value', anchor:'€119.99', price:'€59.99', perDay:'€0.16 / day', save:'save 50%', cta:'get my plan'}
    ],
    reasons:[
