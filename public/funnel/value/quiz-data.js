...
const STEPS = [
  ...
  { id:'trust', type:'trust', sec:4,
    ...
    stat:'18,400+', statLabel:'sessions built this week alone',
    rating:'4.9', ratingLabel:'from 3,100+ ratings',
  ...
  /* paywall — premium price + HARD yearly push + aggressive anchoring.
     value-stack + cost comparison + urgent social proof + countdown. */
  { id:'paywall', type:'paywall', sec:4,
    countdown:600,
    title:'your kokoro plan is ready.',
    sub:'tonight’s session and your 7-day reset are waiting — built in your tone, for exactly what you said. the yearly plan works out to <em>€0.22 / day</em>.',
    perks:[
      'tonight’s personalized meditation',
      'a 7-day emotional reset plan',
      'daily check-ins from kokoro',
      'unlimited sessions, made from your words',
      'every voice — gentle, blunt, bedtime'
    ],
    valueStack:[
      {k:'unlimited personalized sessions', was:'€180 / yr'},
      {k:'the 7-day emotional reset plan', was:'€39'},
      {k:'daily check-ins that adapt to you', was:'€60 / yr'},
      {k:'every voice — gentle · blunt · bedtime', was:'€48'},
      {k:'your private vent space, always open', was:'priceless'}
    ],
    valueTotal:'€327 / yr',
    plans:[
      {name:'12 months', note:'billed €79.99 / year · cancel anytime', anchor:'€199.99', price:'€79.99', perDay:'€0.22 / day', best:true, save:'save 60%', cta:'get my plan'},
      {name:'1 month', note:'billed monthly · cancel anytime', anchor:'€39.99', price:'€24.99', perDay:'€0.83 / day', cta:'get my plan'},
      {name:'1 week', note:'billed weekly · cancel anytime', anchor:'€14.99', price:'€9.99', perDay:'€1.43 / day', cta:'get my plan'}
    ],
    compare:{
      themLbl:'one therapy session', themPrice:'~€80', themSub:'one hour, once.',
      usLbl:'kokoro, yearly', usPrice:'€0.22', usSub:'every day, all year. less than one coffee a week.'
    },
    reasons:[
      {k:'made from your words', v:'not a generic library — tonight’s sit is built from what you told kokoro.'},
      {k:'cheaper than one coffee a week', v:'<em>€0.22 a day</em> for something that meets you on the worst nights. the maths is not close.'},
