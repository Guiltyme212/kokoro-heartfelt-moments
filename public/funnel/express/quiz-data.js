/* =====================================================
   Kokoro — EXPRESS funnel (short & fast variant)
   Same emotional punch + interactive in-between screens
   (projection graph, the pattern reveal, the build/loading
   screen, a fact + testimonials, the anchored paywall) —
   but the QUESTION steps are trimmed to the highest-impact
   emotional core (~12-13 perceived questions vs ~20).
   Pricing strategy: no free trial, discount-anchored,
   per-day framing, countdown. Engine: quiz-flow.js.
   ===================================================== */
...
const STEPS = [
  ...
  { id:'solution', type:'stmt', eyebrow:'how this works',
    ...
    p:'a few quick questions, then one true thing. takes about 2 minutes.', cta:'okay, let’s start' },
  ...
  { id:'paywall', type:'paywall', sec:4,
    ...
    plans:[
      {name:'12 months', note:'billed €59.99 / year', anchor:'€119.99', price:'€59.99', perDay:'€0.16 / day', best:true, save:'save 50%', cta:'get my plan'},
      {name:'1 month', note:'billed monthly · cancel anytime', anchor:'€29.99', price:'€19.99', perDay:'€0.66 / day', cta:'get my plan'},
      {name:'1 week', note:'billed weekly · cancel anytime', anchor:'€11.99', price:'€7.99', perDay:'€1.14 / day', cta:'get my plan'}
    ],
    reasons:[
