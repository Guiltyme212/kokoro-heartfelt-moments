...
const STEPS = [
  ...
  /* paywall — "almost-zero" per-day price card (Playa-style formula):
     urgency bar + applied promo code + per-day hero pricing + popular badge.
     Plan order here matches STRIPE_LINKS index in quiz-flow.js (week·month·year).
     Pre-selected plan is the one flagged popular (the 4-week). */
  { id:'paywall', type:'paywall', sec:4,
    countdown:600,
    expiry:'your result and personalized offer expires in',
    promo:{ pct:'50%', title:'your promo code is applied', sub:'50% off your first plan', code:'KOKORO50' },
    heading:'choose your plan to unlock your full result and personalized meditation plan',
    plans:[
      {name:'1-week plan',   note:'your 7-day reset',   off:'-30%', anchor:'€14.99',  price:'€9.99',  cur:'€', big:'1', dec:'.43', cta:'get my result & plan'},
      {name:'4-week plan',   note:'most chosen',        off:'-50%', anchor:'€49.99',  price:'€24.99', cur:'€', big:'0', dec:'.89', popular:true, sel:true, cta:'get my result & plan'},
      {name:'12-month plan', note:'best value',         off:'-60%', anchor:'€199.99', price:'€79.99', cur:'€', big:'0', dec:'.22', best:true, cta:'get my result & plan'}
    ],
    proof:'people who pick the 4-week plan are 2.3× more likely to still be sitting with kokoro a month later.' },
